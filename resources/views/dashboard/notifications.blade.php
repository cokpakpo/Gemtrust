           ...
           <tr>
              @foreach ($details[$i] as $detail)
                ...
                <form method="post" action="{{url('/notifications')}}">
                 {{ csrf_field() }}
                <input type="hidden" name="sender" value="{{$detail->id}}">
                <input class="w3-button w3-light-blue w3-padding-16 w3-hover-white w3-card-4"  type="submit" value="Confirm Payment">
                </form>
