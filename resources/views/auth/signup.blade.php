...
<div style="padding-top: 100px">
 <div class="w3-row">
  ...
  <div class="w3-col m6 w3-dark-grey">
    <form class="w3-container w3-card-4 w3-dark-grey-grey" method="POST" action="{{ url('/signup') }}">
     {{ csrf_field() }}
...
<p class="form-group{{ $errors->has('package') ? ' has-error' : '' }}">      
    <label>Package</label>
    <select class="w3-input w3-border-0" id="package" name="package" type="text" required>
